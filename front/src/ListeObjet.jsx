...
import FilterCategorie from './Filters.jsx' // import du composant enfant
...
function ListeObjets() {
    ...
    const objetsFiltres = useMemo(() => {
        if (selecteCategorie === "all") return objet // pas de filtre = on garde tout
        return objet.filter((o) => o.categorie_libelle === selecteCategorie)
    }, [selecteCategorie, objet])
